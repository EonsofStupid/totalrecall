...
uv --project tests run bash ./tests/integration-tests.sh # generates trecall-openapi-*.profraw files
uv --project tests run bash ./tests/integration-tests.sh distributed # generates trecall-openapi-*.profraw files
uv --project tests run pytest tests/consensus_tests --durations=10 # generates trecall-consensus-tests-*.profraw files
