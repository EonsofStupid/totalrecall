...
# Download `dist.zip` from the latest release of https://github.com/trecall-web-ui and unzip given folder

# Get latest dist.zip
DOWNLOAD_LINK="https://github.com/trecall-web-ui/releases/latest/download/dist-qdrant.zip"
